...
public class BoardTest {
    ...
    public void testLegalSquare() {
        ...
        assertTrue(B.isLegal(RED, 3, 2));
        assertFalse(B.isLegal(RED, 3, 3));
    }
    ...
    public void testWin() {
        Board B = new Board(4);
        for (int i = 0; i < 16; i += 1) {
            B.internalSet(i, fillSpots1[i], fillPlayers1[i]);
        }
    ...
    @Test
    public void testLegalRC() {
        Board B = new Board(4);
        for (int i = 0; i < 16; i += 1) {
            B.internalSet(i, fillSpots1[i], fillPlayers1[i]);
        }
        System.out.println(B);
        for (int n = 0; n < B.size() * B.size(); n += 1) {
            if (n % B.size() == 0) {
                System.out.println("\n");
            }
            System.out.print(B.isLegal(RED, n) + " ");
        }
    }
